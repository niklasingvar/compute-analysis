...
- **Användning**: Internationell policykontext för varför compute- och AI-kapacitet är strategisk (jfr [08-strategi.md](08-strategi.md), [resources/links.md](resources/links.md) **L1**)

---

## 8. Policy- och strategikällor (kompletterande register)

För [08-strategi.md](08-strategi.md) används en separat, nyckelstyrd källlista med fullständiga URL:er och kort metadata: **[resources/links.md](resources/links.md)** (nycklar **L1**–**L11** — bl.a. SOU 2025:12, Europaparlamentet om teknisk suveränitet, CLOUD Act/Schrems II, eSam, Epoch AI, Mistral, GPT-SW3, EU AI Act). Detta avsnitt i 05 behåller övergripande källor för beräkningsmodellen; dubblera inte alla L-poster här om inte särskild anledning finns.
